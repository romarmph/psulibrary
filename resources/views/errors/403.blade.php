  ...
  <section class="flex items-center justify-center w-full h-screen">
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
      <div class="flex flex-col items-center justify-center max-w-screen-sm mx-auto text-center">
        ...
        <h1 class="mb-4 font-extrabold tracking-tight text-blue-600 text-7xl lg:text-9xl dark:text-blue-500">403</h1>
        <p class="mb-4 text-3xl font-bold tracking-tight text-gray-900 md:text-4xl dark:text-white">Opps...</p>
        <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Sorry you're not allowed to access this page.</p>
