<div>
  <div class="flex flex-col items-center justify-center p-8 text-center bg-white rounded-lg">
    ...
    <div class="flex gap-4 justify-stretch">
      <button wire:click="$dispatch('closeModal')">No, do not release</button>
      <button wire:click="requestRelease({{ $request_id }})" class="p-4 text-center text-white bg-green-500 rounded-lg">Yes, continue</button>
    </div>
  </div>
</div>
