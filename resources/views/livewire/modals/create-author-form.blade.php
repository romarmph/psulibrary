<div>
  <section class="bg-white dark:bg-gray-900">
    <div class="max-w-2xl p-4">
      <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add a new author</h2>
